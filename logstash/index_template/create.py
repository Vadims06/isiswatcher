...
if __name__ == '__main__':
    ...
    indexTempateNameToSettings['isis-watcher-updown-events'] = {'index_patterns': ['watcher-updown-events*'], 'template': {'mappings': {'dynamic': False, 'properties': {"@timestamp": {"type": "date"},"watcher_time": { "type": "date", "format": "date_optional_time"},"watcher_name": {"type": "keyword"},"level_number": {"type": "keyword"},"event_name": {"type": "keyword"},"event_object": {"type": "keyword"},"event_status": {"type": "keyword"},"event_detected_by": {"type": "keyword"},"graph_time": {"type": "keyword"}}}}, '_meta': {'description': 'index template for Watcher logs'}, 'allow_auto_create': True}
    indexTempateNameToSettings['isis-watcher-costs-changes'] = {'index_patterns': ['watcher-costs-changes*'], 'template': {'mappings': {'dynamic': False, 'properties': {"@timestamp": {"type": "date"},"watcher_time": { "type": "date", "format": "date_optional_time"},"watcher_name": {"type": "keyword"},"level_number": {"type": "keyword"},"event_name": {"type": "keyword"},"event_object": {"type": "keyword"},"event_status": {"type": "keyword"},"old_cost": {"type": "integer"},"new_cost": {"type": "integer"},"event_detected_by": {"type": "keyword"},"subnet_type": {"type": "keyword"}, "shared_subnet_remote_neighbors_ids": {"type": "keyword"},"graph_time": {"type": "keyword"}}}}, '_meta': {'description': 'index template for Watcher OSPF costs changes logs'}, 'allow_auto_create': True}
